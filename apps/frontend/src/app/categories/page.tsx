...
// Explicitly define PageProps for the dynamic route
interface SpecificCategoryPageProps {
  params: {
    categoryId: string; // Matches the [categoryId] filename
  };
}

// Ensure the component returns a React node and handles params correctly
